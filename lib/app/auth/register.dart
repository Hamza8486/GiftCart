                  ...
                  AppButton(
                      ...
                      onTap: () {
                        ...
                        if(validateRegister(context)){
                          if(isCheck==true){
                            Get.put(AuthController()).updateEmail(Get.put(AuthController()).emailRegController.text);
                            Get.put(AuthController()).updatePass(
                                Get.put(AuthController()).passRegController.text);
