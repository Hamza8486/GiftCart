...
class VendorFaqView extends StatelessWidget {
  const VendorFaqView({Key? key}) : super(key: key);
                    ...
                    child: Column(
                      children: [
                        Obx(
                                () {
                              return
                                Get.put(VendorController()).faqLoading.value?
                                Column(
                                ...
                                ListView.builder(
                                  ...
                                  itemCount: Get.put(VendorController()).faqList.length,
                                  itemBuilder: (context, index) {
                                    return Padding(
                                      padding:  EdgeInsets.symmetric(vertical: 10,horizontal: 12),
                                      child: ExpandBox(
                                        text:
                                        Get.put(VendorController()).faqList[index].question,
                                        text1: Get.put(VendorController()).faqList[index].answer,
                                      ),
                                    );
                                  },
                                );
        ...
        child: Theme(
          ...
          child: Padding(
            ...
            child: ExpansionTile(
              ...
              trailing: Get.put(VendorController()).expand.value == true
              ...
              onExpansionChanged: (bool val) {
                Get.put(VendorController()).expand.value = val;
              },
