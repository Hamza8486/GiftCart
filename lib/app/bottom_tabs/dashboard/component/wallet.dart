                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            AppText(
                              title: wallet=="wallet"?"Wallet":"Gift Wallet",
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              wallet!="gift"?SizedBox.shrink():
                              SizedBox(width: 13,),
                              wallet!="gift"?SizedBox.shrink():
                              GestureDetector(
                                onTap: (){

                                  Get.to(AllData(name: "Payment process",link: "https://admin.mr-corp.ca/help/Payment%20process",));
              ...
              child: Column(
                children: [
                  ...
                  Obx(
                          () {
                        return
                          Get.put(PaymentController()).checkLoader1.value?Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              SizedBox(height: 200,),
