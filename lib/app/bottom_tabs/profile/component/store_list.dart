...
import 'package:giftcart/app/vendor_home/vendor_tabs/vendor_dashboard/component/payments.dart';
...
class _StoreListState extends State<StoreList> {
  ...
  List cat = [restaurants.tr, grocery.tr, furniture.tr, liquorStore.tr];
      ...
      body: Stack(
        children: [
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Obx(() {
                          return authController.allAdsLoader.value
                              ? Center(
                        ...
                        Obx(
                          () {
                            return
                              authController.getAllAdsList.isNotEmpty?SizedBox.shrink():
                        ...
                        Obx(() {
                          return authController.storeLoader.value
                              ? Column(
                                  children: [
                                    SizedBox(
                              ...
                              : authController.getStoreList.isEmpty
                                  ? Column(children: [
                            ...
                            SizedBox(height: Get.height * 0.01),
                                  ...
                                  : ListView.builder(
                                      itemCount:
                                          authController.getStoreList.length,
                                      shrinkWrap: true,
                                      primary: false,
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        authController
                                                            ...
                                                            : AppText(
                                                                title:
                                                                    "opens at ${DateFormat('hh:mm a').format(DateFormat('HH:mm:ss').parse((authController.getStoreList[index].openTime).toString()))} onwards",
                                                                size: 10,
                                                                fontWeight:
                                                                    FontWeight
                                                                        .w700,
          ...
          Positioned(
              ...
              right: widget.type == "part" ? 20 : 100,
              child: GestureDetector(
                onTap: () {
                  Get.to(AllData(name: "Payment grocery store",link: "https://admin.mr-corp.ca/help/Payment%20to%20grocery%20store",));
                },
                child: Image.asset(
          ...
          Positioned(
              top: Get.height * 0.061,
              right: widget.type == "part" ? 0 : 20,
              child: widget.type == "part"
                  ? SizedBox.shrink()
                  : GestureDetector(
                      onTap: () {
