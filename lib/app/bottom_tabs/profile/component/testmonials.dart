...
// import 'package:giftcart/app/bottom_tabs/profile/component/video_view.dart';
...
class _TestimonialsState extends State<Testimonials> {
      ...
      TargetFocus(identify: "item", keyTarget: item, contents: [
        TargetContent(
          ...
          builder: (context, controller) {
            return Cochmarkdesc(
              text:
                  "Explore heartening testimonials from our members who received complimentary groceries for a year. Join Gift Cart today and embrace the delight of being part of our unique family!",
              onnext: () {
                controller.next();
  ...
  void initState() {
    ...
    HelperFunctions.getFromPreference("test").then((value) {
      nameValue = value;
      print(nameValue.toString());
      if (value == "value") {
      } else {
        HelperFunctions.saveInPreference("test", "value");
